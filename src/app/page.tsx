...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="mx-auto max-w-6xl px-4 sm:px-4 py-8 sm:py-20 text-center">
        ...
        <p className="mt-3 sm:mt-6 text-base sm:text-xl text-zinc-400 sm:text-2xl px-2">
        ...
        <div className="mt-6 sm:mt-10 flex flex-col items-center justify-center gap-3 sm:gap-4 sm:flex-row">
          <Link
            href="/league"
            className="w-full sm:w-auto rounded-xl border border-emerald-800 bg-emerald-900 px-6 py-3 sm:px-8 sm:py-4 text-base sm:text-lg font-semibold text-emerald-100 transition-all hover:bg-emerald-800 hover:shadow-lg hover:shadow-emerald-900/50"
          >
            Get Started
          </Link>
          <Link
            href="/history"
            className="w-full sm:w-auto rounded-xl border border-zinc-800 bg-zinc-900 px-6 py-3 sm:px-8 sm:py-4 text-base sm:text-lg font-semibold text-zinc-100 transition-all hover:bg-zinc-800"
          >
            View History
          </Link>
        </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-8 sm:py-16">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-4xl font-bold text-zinc-100 mb-3 sm:mb-4">
            Free Fantasy Football Draft Lottery Generator for Sleeper Leagues
          </h2>
          <p className="mt-3 sm:mt-4 text-sm sm:text-xl text-zinc-400 max-w-3xl mx-auto px-2">
      ...
      <section className="mx-auto max-w-6xl px-4 py-8 sm:py-16">
        ...
        <div className="mt-8 sm:mt-16 grid gap-4 sm:gap-8 md:grid-cols-2 lg:grid-cols-3">
          {/* Reason 1 */}
          <div className="rounded-2xl border border-zinc-800 bg-zinc-950/40 p-4 sm:p-6">
            <div className="mb-3 sm:mb-4 flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-emerald-900/40 border border-emerald-800">
      ...
      <section className="mx-auto max-w-6xl px-4 py-8 sm:py-16">
        <div className="rounded-2xl border border-zinc-800 bg-zinc-950/40 p-4 sm:p-8 md:p-12">
      ...
      <section className="mx-auto max-w-6xl px-4 py-8 sm:py-16">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-4xl font-bold text-zinc-100 mb-3 sm:mb-4">
        ...
        <div className="grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
          <Link href="/guides/how-to-use-draft-lottery" className="rounded-2xl border border-zinc-800 bg-zinc-950/40 p-4 sm:p-6 hover:border-emerald-800 hover:bg-zinc-950/60 transition-all">
          ...
          <Link href="/guides/prevent-tanking" className="rounded-2xl border border-zinc-800 bg-zinc-950/40 p-4 sm:p-6 hover:border-emerald-800 hover:bg-zinc-950/60 transition-all">
            <h3 className="text-lg sm:text-xl font-semibold text-zinc-100 mb-2">
          ...
          <Link href="/guides" className="rounded-2xl border border-zinc-800 bg-zinc-950/40 p-4 sm:p-6 hover:border-emerald-800 hover:bg-zinc-950/60 transition-all">
            <h3 className="text-lg sm:text-xl font-semibold text-zinc-100 mb-2">
              View All Guides
            </h3>
            <p className="text-zinc-400 text-xs sm:text-sm">
      ...
      <section className="mx-auto max-w-6xl px-4 py-8 sm:py-16">
        <div className="rounded-2xl border border-emerald-800 bg-emerald-950/20 p-6 sm:p-12 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-emerald-100 mb-3 sm:mb-4">
            Ready to Transform Your Draft?
          </h2>
          <p className="text-sm sm:text-lg text-emerald-200/80 mb-6 sm:mb-8 max-w-2xl mx-auto px-2">
          ...
          <Link
            href="/league"
            className="inline-block w-full sm:w-auto rounded-xl border border-emerald-800 bg-emerald-900 px-6 py-3 sm:px-8 sm:py-4 text-base sm:text-lg font-semibold text-emerald-100 transition-all hover:bg-emerald-800 hover:shadow-lg hover:shadow-emerald-900/50"
          >
            Start Your Lottery
          </Link>
        </div>
